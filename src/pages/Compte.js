  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.formContainer}>
        <h1 style={{ textAlign: 'center', marginBottom: '1.5rem' }}>Mon Compte</h1>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <input style={styles.input} type="text" name="adresse" value={form.adresse} onChange={handleChange} placeholder="Adresse de livraison" />
